...
while(booleanA):
    ...
    mangaNameDictionary = {"One Piece": "one-piece", "Kaiju No 8": "kaiju-no-8", "Mashle": "mashle", "Jujutsu Kaisen": "jujutsu-kaisen", "Black Clover": "black-clover", "Chainsaw Man": "chainsaw-man", "We never learn": "we-never-learn", "Undead Unlock": "undead-unluck", "Agravity Boys": "agravity-boys", "Ayakashi Triangle": "ayakashi-triangle", "Dr Stone": "dr-stone",
                           "Hard Boiled Cop and Dolphin": "hard-boiled-cop-and-dolphin", "Magu Chan: God of Destruction": "magu-chan-god-of-destruction", "Mission: Yozakura Family": "mission-yozakura-family", "Moriking": "moriking", "Our Blood Oath": "our-blood-oath", "Phantom Seer": "phantom-seer", "My Hero Academia": "my-hero-academia", "Spy x Family": "spy-x-family"}
    ...
    elem = browser.find_element_by_xpath(
        '//*[@id="section0"]/div/div[2]/div[2]/a/div[2]/table/tbody/tr/td[2]/div/span')
    elem.click()
